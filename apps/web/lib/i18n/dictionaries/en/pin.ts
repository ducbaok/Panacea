...
export const pin: Mirror<Vi> = {
  ...
  'pin.fieldSourceUrl': 'Source link',
  'pin.errSourceUrl': 'The source link must be a valid URL.',
  'pin.fieldTags': 'Tags',
  ...
  'pin.fieldCategories': 'Categories',
  'pin.categoriesLeft': '{n} category left|{n} categories left',
  'pin.categoriesCapped': 'At most 3 categories per pin.',
